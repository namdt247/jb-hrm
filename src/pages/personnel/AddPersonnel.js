                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" placeholder="Nơi sinh" />
                                </Form.Group>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" placeholder="Dân tộc" />
                                </Form.Group>

                                <Form.Group className="mb-3">
                                    <Form.Label>Địa chỉ thường trú</Form.Label>
                                    <Form.Control type="text" placeholder="Địa chỉ thường chú" />
                                </Form.Group>

                                <Form.Group className="mb-3">
                                    <Form.Label>Nghề nghiệp</Form.Label>
                                    <Form.Control type="text" placeholder="Nghề nghiệp" />
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Group className="mb-3">
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" placeholder="Tôn giáo" />
                                </Form.Group>
                        ...
                        <Row>
                            <Col>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" placeholder="Chức vụ hiện tại" />
                                </Form.Group>

                                <Form.Group className="mb-3">
                                    <Form.Label>Trình độ giáo dục phổ thông</Form.Label>
                                    <Form.Control type="text" placeholder="12/12" />
                                </Form.Group>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" placeholder="Ngoại ngữ" />
                                </Form.Group>
                            ...
                            <Col>
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" placeholder="Cơ quan tuyển dụng" />
                                </Form.Group>

                                <Form.Group className="mb-3">
                                    <Form.Label>Công việc được giao</Form.Label>
                                    <Form.Control type="text" placeholder="Công việc được giao" />
                                </Form.Group>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="text" placeholder="Trình độ tin học" />
                                </Form.Group>
