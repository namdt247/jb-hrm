...
import {AppointTable, PersonnelTable, ReportIncreaseSalaryTable, ReportSalaryTable} from "../../components/Tables";
import {Link} from "react-router-dom";
import {Routes} from "../../routes";
import MPagination from "../../components/MPagination";


function ReportIncreaseSalary() {
    return (
        <>
            <h4>Báo cáo tổng hợp nâng lương</h4>
            ...
            <ReportIncreaseSalaryTable />
            <MPagination />
        </>
    );
};

export default ReportIncreaseSalary;
