...
import {AppointTable, PersonnelTable, ReportSalaryAllowanceTable, ReportSalaryTable} from "../../components/Tables";
import {Link} from "react-router-dom";
import {Routes} from "../../routes";
import MPagination from "../../components/MPagination";


function ReportSalaryAllowance() {
    return (
        <>
            <h4>Báo cáo phụ cấp lương</h4>
            ...
            <ReportSalaryAllowanceTable />
            <MPagination />
        </>
    );
};

export default ReportSalaryAllowance;
